...
import { ArrowUpRight, Eye, EyeOff, Pencil, Trash2, Users } from "lucide-react";
...
export function DeskCard({
  ...
  return (
    <article
      className={
        "group flex flex-col rounded-3xl border border-border bg-card p-5 shadow-soft transition-all duration-300 hover:-translate-y-1 hover:shadow-glow" +
